...
if (empty($nisn)) {
    echo "<script>alert('NISN tidak ditemukan.'); window.location='lihatsiswa-guru.php';</script>";
    exit;
}
...
if (!$data_siswa) {
    echo "<script>alert('Data siswa tidak ditemukan.'); window.location='lihatsiswa-guru.php';</script>";
    exit;
}
    ...
    <div class="form-edit-profil">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="edit-profile-buttons">
                <a href="lihatsiswa-guru.php" value="Back" id="edit-button"> Back </a>
            </div>
        </form>
    </div>
