...
$hasil_mapel = mysqli_query($conn, $sql);
?>
...
.icon-action:hover {
  ...
  <body>
    ...
    <div class="d-flex justify-content-between mb-2">
        <div>
            <p class="fw-bold">Data Mata Pelajaran</p>
        </div>
        <div>
            <a href="addmapel-admin.php" class="btn btn-success">Tambah Mapel</a>
        </div>
    </div>
    
    <div class="mb-3 d-flex justify-content-end">
        <input type="search" class="form-control" style="width: 200px;" id="searchInput" onkeyup="searchTable()" placeholder="Cari Mapel...">
    </div>
    ...
    <thead>
        <tr>
            ...
            <th onclick="sortTable(1)">Kode Mapel<span class="iconify" data-icon="akar-icons:arrow-up-down"></span></th>
            <th onclick="sortTable(2)">Tingkat Kelas<span class="iconify" data-icon="akar-icons:arrow-up-down"></span></th>
            <th onclick="sortTable(3)">Nama Mapel<span class="iconify" data-icon="akar-icons:arrow-up-down"></span></th>
            <th>Action</th>
        </tr>
    </thead>
    <tbody>
    ...
    foreach($hasil_mapel as $mapel): ?>
    <tr>
    <td><?php echo $no++; ?></td>
    <td><?php echo $mapel['kode_mapel']; ?></td>
    <td><?php echo $mapel['tingkat_kelas']; ?></td>
    ...
    <td>
        ...
        <!-- Tombol Edit -->
        <a href="editmapel-admin.php?id_mapel=<?php echo $mapel['id_mapel']; ?>" class="btn btn-primary btn-sm">
            <iconify-icon icon="bxs:edit"></iconify-icon>
        </a>
        <!-- Tombol Delete -->
        <button onclick="confirmDelete('<?php echo $mapel['id_mapel']; ?>')" class="btn btn-danger btn-sm">
