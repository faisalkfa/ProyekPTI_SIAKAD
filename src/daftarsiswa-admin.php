  ...
  <body>
    ...
    <div class="kotak-isi">
       ...
       <div class="d-flex justify-content-between mb-2">
        ...
        <div>
            <a href="addsiswa-admin.php" class="btn btn-success">Tambah Siswa</a>
        </div>
        </div>
            <div class="text-end">
                <select class="form-select border-dark" id="kelasselect" name="kode_kelas" style="width: 150px;" onchange="fetchDataListSiswa(this.value)">
